...
class GridHabitaciones:
        ...
        try:
            habitaciones = (
                ...
                .options(
                    ...
                    selectinload(Habitacion.estadias_activas)
                    .selectinload(Estadia.folio_lineas),   # ← v2: folio_lineas
                )
    ...
    def crear_tarjeta_habitacion(self, habitacion: Habitacion) -> ft.Container:
        try:
            ...
            if habitacion.estado == EstadoHabitacion.OCCUPIED:
                ...
                if estadia_activa:
                    # v2: folio_lineas en lugar de lineas_cuenta
                    tiene_pendiente = any(
                        not fl.cancelada
                        for fl in (estadia_activa.folio_lineas or [])
                    )
            ...
            badge_sale_hoy = ft.Container(
                ...
                border_radius=ft.border_radius.only(top_right=10, bottom_left=8),
                right=0, top=0,
                visible=sale_hoy,
            )
            ...
            return ft.Container(
                ...
                shadow=ft.BoxShadow(
                    ...
                    color=ft.Colors.BLACK12, offset=ft.Offset(1, 4),
                ),
                content=ft.Stack([
    ...
    def al_pasar_cursor(self, evento, color_acento, tiene_pendiente=False):
        color_hover = ft.Colors.YELLOW_700 if tiene_pendiente else color_acento
